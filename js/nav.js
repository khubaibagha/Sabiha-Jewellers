...
(function() {
  ...
  <header class="site-header">
    <div class="h-inner">
      <a href="${B}index.html" class="h-logo">
        <img src="${B}Images/logo-sabihas.jpeg" alt="sabihas jewellery" class="h-logo-img">
      </a>
      <div class="h-right">
        <div class="h-contact-info">
          <span class="h-ci-hours">Online Store &nbsp;·&nbsp; Worldwide Shipping</span>
          <a href="https://wa.me/923212110805" target="_blank" rel="noopener" class="h-ci-phone">
            <svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
            WhatsApp Us
          </a>
        </div>
        <a href="https://wa.me/923212110805" target="_blank" rel="noopener" class="h-btn-appt">Shop Now</a>
          ...
          <div class="dropdown">
            <div class="dropdown-inner">
              <div>
                ...
                <a href="${B}about.html" class="dd-link">About Sabiha Jewellery</a>
                <a href="${B}about.html#promise" class="dd-link">Our Promise</a>
                <a href="${B}about.html#craftsmanship" class="dd-link">Craftsmanship</a>
              </div>
              <div>
                <div class="dd-col-head">Connect</div>
                <a href="${B}reviews.html" class="dd-link">Customer Reviews</a>
                <a href="https://instagram.com/sabihasjewellery" target="_blank" rel="noopener" class="dd-link">Instagram</a>
                <hr class="dd-divider">
                <a href="${B}contact.html" class="dd-link featured">&rarr; Contact Us</a>
              </div>
            </div>
          </div>
        </li>
  ...
  <div class="site-info-strip">
    <div class="sis-inner">
      <span class="sis-item">
        <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/><path d="M2 12h20"/></svg>
        Worldwide Shipping Available
      </span>
      <div class="sis-div"></div>
      <a href="https://wa.me/923212110805" target="_blank" rel="noopener" class="sis-item">
        <svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
        WhatsApp: +92 321 2110805
      </a>
      <div class="sis-div"></div>
      <a href="https://instagram.com/sabihasjewellery" target="_blank" rel="noopener" class="sis-item">
        <svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
        @sabihasjewellery &nbsp;&middot;&nbsp; 36K+ Followers
      </a>
      <div class="sis-div"></div>
      <span class="sis-item">
        <svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9,12 11,14 15,10"/></svg>
        100% Authentic Gold Jewellery
      </span>
    </div>
  </div>`;
